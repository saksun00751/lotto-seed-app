    ...
    <main className="min-h-screen bg-surface-subtle pb-10">
      ...
      <div className="relative max-w-5xl mx-auto px-5 pt-6 space-y-6">
        <div className="flex items-center justify-between gap-3">
          ...
          <Link
            href={`/${locale}/login`}
            className="inline-flex items-center gap-2 rounded-full border border-ap-border bg-surface-card px-4 py-2 text-[13px] font-semibold text-ap-primary hover:border-ap-blue/40 transition-colors whitespace-nowrap"
          >
            {loginT.submitLogin}
          </Link>
        </div>
