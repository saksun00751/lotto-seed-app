...
export default function YeekeeRewardPolicy({
  ...
  return (
    <section className="rounded-2xl border border-border-default bg-white shadow-card overflow-hidden">
      <div className="px-4 py-3 bg-gradient-to-r from-sky-500 to-cyan-400 border-b border-border-default">
        ...
        {policy.map((p, idx) => (
          <li key={`${p.position ?? idx}`} className="px-4 py-2.5 flex items-center justify-between gap-3 hover:bg-sky-50/50">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <p className="text-[14px] font-bold text-text-strong truncate">
