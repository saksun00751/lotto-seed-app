...
export default function BetLinkButton({
  ...
  return (
    <>
      <button
        onClick={handleClick}
        className="inline-flex w-full items-center justify-center gap-1.5 whitespace-nowrap bg-brand-primary text-white rounded-full py-2 text-[14px] font-semibold hover:bg-brand-primary-hover transition-colors active:scale-95"
      >
